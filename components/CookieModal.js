...
const youtubeKey = 'accept-youtube-cookie';
const googleKey = 'accept-google-ads-cookie';
...
const CookieModal = () => {
	...
	const acceptAll = e => {
		setOpen(false);
		setOpenBand(false);
		setCookie(youtubeKey, 'true');
		setCookie(googleKey, 'true');
	...
	const rejectAll = e => {
		setOpen(false);
		setOpenBand(false);
		setCookie(youtubeKey, 'false');
		setCookie(googleKey, 'false');
	...
	const acceptSome = e => {
		setOpen(false);
		setOpenBand(false);
		setCookie(youtubeKey, `${checkedYtb}`);
		setCookie(googleKey, `${checkedGAds}`);
	...
	useEffect(() => {
		const youtube = getCookie(youtubeKey);
		const googleAds = getCookie(googleKey);
